        ...
        <?php div('container menuXX') ;?>
         ...
         <div class="col-sm-12 " style="margin-top:60px">
            ...
            <div class="col-sm-12 " style="margin-top:60px">
                ...
                <div class="col-sm-6"><h2  style="color:green;" ><center>สมัครสมาชิกเรียบร้อย</center></h2><hr></div>
                  <div class="col-sm-3"></div>
                </div>
        
        <div class="col-sm-5"></div>
        <div class="col-sm-2">
            <a class="btn btn-primary btn-block" type="submit" href="../index.php">ตกลง</a>
