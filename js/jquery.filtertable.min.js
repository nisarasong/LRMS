! function($) {
  ...
  t < 2 && i < 8 ? ($.expr[":"].filterTableFind = function(e, t, i) {
    ...
    var t = {
        ...
        minChars: 1,
        minRows: 8,
        placeholder: "กรอกชื่ออาหารหรือรหัส",
        preventReturnKey: !0,
        quickList: [],
    ...
    return this.each(function() {
      ...
      if ("TABLE" === e[0].nodeName && t.length > 0 && (0 === n.minRows || n.minRows > 0 && t.find("tr").length >= n.minRows) && !e.prev().hasClass(n.containerClass)) {
        if (n.inputSelector && 1 === $(n.inputSelector).length ? (s = $(n.inputSelector), a = s.parent(), c = !1) : (a = $("<" + n.containerTag + " />"), "" !== n.containerClass && a.addClass(n.containerClass), a.prepend(n.label + " "), s = $('<input   class="form-control" type="' + n.inputType + '" placeholder="' + n.placeholder + '" name="' + n.inputName + '" />'), n.preventReturnKey && s.on("keydown", function(e) {
